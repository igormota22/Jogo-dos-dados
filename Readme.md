...
**Bonus -** ao cair nas casas 5,10,15 ou 25 são avançadas 3 posiçoes adicionais.E ao tirar 6 no dado é concedida uma rodada extra.
...
**- Casas de evento:** ao cairem em determinadas posiçoes,o jogador ou a maquina podem ganhar um bonus, sofrer uma penalidade (ou ganhar uma rodada extra ao tirar 6) ao depender da casa.
